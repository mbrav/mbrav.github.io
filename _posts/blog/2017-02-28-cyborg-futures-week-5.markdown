...
While making this prototype, I continued to have in mind the *input* and *output* aspect that I discussed in [Week's 4 blog ]({{ site.url }}/blog/2017/02/21-cyborg-futures-week-4), that is, that the inputs and outputs can be interchangeable because they are made out of technology that itself is interchangeable.

...
The structure of the musical beat is what gives objectivity to music, but does not prevent music to reveal and expound its subjective inner life. This is what allows a musical piece to exist on its own account; where inner life is an ideal whose "subjective passions and feeling of character and heart" is revealed, but is nevertheless preoccupied with the sphere of its own circumstances, aims, and actions.[^10] As Hegel states, no matter how deeply one plunges to admire and comprehend the subject-matter in a painting — "it is all in vein" — because our relation to these depicted objects is rarely elaborated beyond the mere act of eye gazing and spectating. When a beholder recollects a melody, it is for this exact reason that such a recollection is rarely that of notes in their bare structural form, but one which is theoretical and emotional. These recollections are deeply emotional, but at the same time, these are theoretical conceptions of a melodic play among the notes — which quite paradoxically, emerge out of a strictly devised structure and composition.

When compared to the visual arts, music expresses object-free inner life that is ideally and theoretically elaborated in what Hegel refers to as “abstract subjectivity”[^3]. This form of theoretical elaboration contrasts with the form of expression devised in other forms of art, whose subject-matter is most often contingent to something physical and external. What at first might appear as an irresolution on music’s behalf, especially when compared to the non-temporal features of sculpture and architecture; in actuality, is a potential inherent in the musical medium—that which aids the potential to express musical features that are extensively theoretical and ideal. Music is a form of romantic art that withdraws from the expression of external life, and becomes an expression of inner life — in its own subjectivity. This is what Hegel refers to as the “unfolding” of the 'Absolute Ideal' in music. This unfolding of the Ideal, consists of a meticulous act of working out and expounding its subject-matter, which becomes fully actualized throughout the performance of the melody.

A melody's subject-matter consists of interplays, relations, oppositions, conflicts, transitions, complications, and resolutions; which constitute the melody’s subject-matter, as well as the inner life and character of almost every individual note. Music of high vocation does not simply replicate a natural outburst of passionate notes but transforms music into a theoretical expression—revealing specific notes in their relation to other notes.[^6] However, at the same time, music gains a more theoretical ground for spirited expression due to its objective and structural foundation—but whose essence nevertheless unfolds as something profoundly subjective.[^4]

Along with sight, hearing is one of the only two theoretical senses, contrary to the more practical ones; such as taste, touch, and smell. For Hegel however, hearing as a sense is more ideal than the sense of sight; because sound as such, is a sphere in which a complete cancellation of materiality is possible.[^5] Within the sphere of sound, music is given a medium in which its ideal content and its inner life can unfold. This can be contrasted with other mediums such as architecture and sculpture, which struggle to idealize their ideal content while accounting for every one of their three physical dimensions. Fore example, painting in relation to architecture and sculpture, achieves a more ideal form of actualization of its inner content due to the negation of one of these dimensions—making it a two-dimensional medium instead of a three-dimensional medium. Music on the other hand, negates and strips away the physicality of _all_ these dimensions altogether; which no longer interfere with the actualization of its profoundly theoretical, absolute, and ideal qualities. The only dimension in which music can assert its existence—is _time_, which Hegel refers to as a "sphere" and not a dimension per se. The musical interplay among the notes contained in a melody unfolds exactly within this _sphere of time_.

In this absolute sphere of time, Music achieves immediate self-sufficiency and absolute subjectivity without relying on a contingent externality. It is the _subjective feeling_ that music claimed as its own subject-matter and ideal content[^902], which is why music can actualize feelings attempted to be worked out in other mediums; such as awe and worship in symbolic art; love, mourning, grief in painting; and misery, lament, sorrow in poetry. These are feelings that are profoundly embodied and expressed in music, which makes it a great addition to works of art of other mediums, due to the melody's ability to trigger and actualize these emotions. This makes music a medium that is also "heartfelt"; giving it the ability to trigger the shed of tears, joy, etc., in a manner that is incomparable to any other medium.[^935]

Music can therefore be incorporated with other forms of art to the advantage of both sides. When for example, music is accompanied with poetry to produce a fusion—drama as such, it brings to our soul the feelings that are attempted to be expressed through poetry, but which are triggered and fully actualized when accompanied with music. Here, poetry is the _elucidating interpreter_ of ideas and thoughts for us to apprehend and reproduce, and music presents these subjective feelings as _its subject-matter_ through the use of notes, that inwardize and accompany the poetic work to produce a work of drama and emotion.[^904]

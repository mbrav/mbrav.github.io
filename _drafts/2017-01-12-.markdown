...
We live in a world where technologic and scientific advancements have become means by which we perceive the world. Gone are the days when we would contemplate or guess what the weather would be like on the next day; today, such information is accessible by our fingertips. This information is represented through a void of mathematical and symbolic representations while we distrust our natural intuition and careful observation. Our interpretation about the world is established based on the use of a wide range of technologies such as algebra, logic, statistics, computation, and scientific instruments.
...
Weather prediction is a perfect example of how human observation was substituted by mathematical and symbolic representation. Instead of taking a glimpse at the weather outside to predict the weather for tomorrow, we trust numerically represented information calculated by powerful computers. Statistically, such information is more likely to yield more precise predictions than if we where to make these predictions manually. We can also come to a common agreement when we refer to these weather predicitons because they have proven to be more correct than speculation. By this approach, we manifest universal correctness and keep it of high regard among the ways we perceive the world. Hannah Arendt in her novel *The Human Condition*, defines this way of perceiving the world as *alienation*. She argues that *alienation* is one of the most predominant ways of how modern sciences shape the way humans perceive their environments.[^c2f10daf] 

As we manifest this way of perceiving the world, science and technology make us think in terms that are "cosmic and universal", contrary to the "terrestrial and natural."[^d2c33aab] Entire disciplines of knowledge, such as physics and engineering, have already lost almost all touch with the spoken human language, and are conveyed solely by mathematical script.[^10db5f1c] Even natural sciences based on terrestrial foundations, like biology, are now being increasingly studied from the point of view of molecular biology, nano-biology, and bio-chemistry; disciplines that are are described in notation that is and alienated from terrestrial biology, can be applicable even outside the boundaries of our planet.

A well built scientific instrument will yield a precise reading whether it is on Earth, on Mars, or on the opposite side of our galaxy. Instruments are capable of perceiving more universal and objective measurements than what human senses are able to. But is it necessary to substitute the way we perceive the world to an extent that we understand it in a way that is no different than how a scientific instrument perceives it?
